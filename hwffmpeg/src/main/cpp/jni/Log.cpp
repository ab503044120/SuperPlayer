...
void logv(const char *tag, const char *format, ...) {
  va_list arglist;
  va_start(arglist, format);
  Logger::log(ANDROID_LOG_INFO, tag, format, arglist);
  va_end(arglist);
}
...
void logd(const char *tag, const char *format, ...) {
  va_list arglist;
  va_start(arglist, format);
  Logger::log(ANDROID_LOG_DEBUG, tag, format, arglist);
  va_end(arglist);
}
...
void logw(const char *tag, const char *format, ...) {
  va_list arglist;
  va_start(arglist, format);
  Logger::log(ANDROID_LOG_WARN, tag, format, arglist);
  va_end(arglist);
}
...
void loge(const char *tag, const char *format, ...) {
  va_list arglist;
  va_start(arglist, format);
  Logger::log(ANDROID_LOG_ERROR, tag, format, arglist);
  va_end(arglist);
}
void logf(const char *tag, const char *format, ...) {
  va_list arglist;
  va_start(arglist, format);
  Logger::log(ANDROID_LOG_FATAL, tag, format, arglist);
  va_end(arglist);
}
